...
The time-frequency domain produced by a constant-Q filter bank tuned to the mel scale is therefore covariant with respect to frequency transposition, in the sense that a pitch interval between sine waves will appear as a translation on the mel-frequency axis.
However, 
...
\begin{figure}[t]
    \begin{center}
        ...
        \put(0.1,0){\includegraphics[width=8cm]{figs/fig2_spectrogram.png}}
        \end{picture}
    \end{center}
    \protect\caption{
