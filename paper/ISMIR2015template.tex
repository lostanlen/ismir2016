...
that the harmonic comb is sparse and covariant with respect pitch shift.

For two harmonic partials taken at random between $1$ and $n$,
the probability that they are in octave relation is $1/n$.
