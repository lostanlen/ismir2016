...
As demonstrated in the next section, pitch is the major factor of variability among musical notes of a given instrument, if described by existing MIR features.
