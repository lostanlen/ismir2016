...
The network is trained on categorical cross-entropy with \emph{Adam} \cite{Kingma2015}, a state-of-the-art stochastic optimizer for gradient-based learning. The loss function $\matscr{L}$ is minimized by shuffled mini-batches of size 512, with uniform class distribution.
% Adam optimizer
