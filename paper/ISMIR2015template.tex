...
Tuning auditory filters to a perceptual scale of pitches provides a time-frequency representation of music signals that satisfy the first two of these properties.
