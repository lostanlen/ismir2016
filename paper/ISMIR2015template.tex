...
only be made possible by growing the number of feature maps $K_1$ to be of the
...
where $n$ is typically above 10, the partials appear close to each other and almost
evenly spaced.
The correlation between constant-Q spectra of different pitches is thus
greater towards high frequencies.
