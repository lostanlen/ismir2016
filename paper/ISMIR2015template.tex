...
In order to train the proposed algorithms, we used MedleyDB \cite{Bittner2014}, a dataset of 122 multitracks annotated with instrument activations as well as melodic $f_0$ curves when present. We extracted the monophonic stems corresponding to a selection of eight pitched instruments. Stems with leaking instruments in the background were discarded. We manually checked the resulting set and ruled out recordings with controversial annotations, such as multiple players, prepared guitar, and trumpet with sordina.
