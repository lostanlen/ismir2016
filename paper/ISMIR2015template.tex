...
In order to compare the results against feature engineering methods, we also
trained a random forest of 100 decision trees on a typical "bag-of-features"
comprising spectral bandwidth, centroid, contrast and rolloff, zero-crossing
rate, MFCC features 
