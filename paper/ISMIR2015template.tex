...
transform (DCT) which leads to the mel-frequency cepstral coefficients (MFCC)
...
To validate this claim, we have extracted the MFCC
...
and manufacturers.
Following a well-established rule,
