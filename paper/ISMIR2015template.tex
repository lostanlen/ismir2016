...
chord recognition \cite{Humphrey2012rethinking, Humphrey2012tonnetz},
...
\cite{Dieleman2014, Humphrey2012rethinking, Humphrey2012tonnetz,
Kereliuk2015, Li2015, McFee2015-muda, Schluter2014, Ullrich2014}.
With the aim of understanding the purpose of convolutional weight sharing in such
systems, this article makes no exception.
...
layers, on which our experiment are conducted, has become a \emph{de facto} standard in the MIR community. This ubiquity in the literature suggests that it is well adapted to supervised audio
classifiication problems of moderate size.
...
\ie log-frequency bands $\gamma$ and $\gamma \pm Q$.
