...
% Learned features may lead to uninterpretable overfitting
%On the other, learned features are solely derived from optimizing classification accuracy: thus, they are often less interpretable and may lead to statistical overfitting, especially in MIR when the quantity of thoroughly annotated data is relatively small.
