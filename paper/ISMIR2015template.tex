...
with only minor variations \cite{Dieleman2014, Humphrey2012, Kereliuk2015, Li2015,
...
%
%The depth of the network is a mean of controlling the ratio between contraction and separation and, indirectly,
...
In our experiments, the pitch spiral ranges from $55\,\mathrm{Hz}$ to
$3.5\,\mathrm{kHz}$.
