...
It is thus a starting point for a wide range of MIR applications, which can be separated in two categories: pitch-\emph{relative} (\eg chord estimation \cite{Cho2014}) and pitch-\emph{invariant} (\eg instrument recognition).
