...
\begin{table*}[t]
	...
	\begin{tabular}{|c|cccccccc|c|}
		...
		\hline
		1-d
		& 28.8 & 91.8 & 82.9 & 51.3 & 73.3 & 59.0 & 63.3 & 43.9 & -- \\
		(--k parameters)
		&\s{5.0}&\s{1.1}&\s{1.9}&\s{13.4}&\s{11.0}&\s{6.8}&\s{5.0}&\s{6.3}&-- \\
		\hline
		spiral
		...
		\hline
		2-d \& spiral
		& 82.3 & 86.5 & 86.9 & 45.8 & 97.6 & 51.2 & 66.9 & 73.3 & -- \\
		(--k parameters)
		&\s{3.2}&\s{4.5}&\s{3.6}&\s{2.9}&\s{0.8}&\s{10.6}&\s{5.8}&\s{4.4}&--\\
		\hline
		spiral \& 1-d
		...
		\hline
		2-d \& 1-d \& spiral
		& 75.0 & 88.0 & 85.9 & 48.3 & 97.8 & 59.0 & 67.3 & 70.9 & --  \\
		(--k parameters)
		&\s{4.3}&\s{3.7}&\s{3.8}&\s{6.6}&\s{0.6}&\s{7.3}&\s{4.4}&\s{6.1}&--\\
		\hline
	\end{tabular}
	\end{center}
