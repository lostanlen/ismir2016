...
% Title.
% ------
\title{Deep convolutional networks on the pitch spiral for instrument recognition}
...
of deep learning architectures for instrument recognition,
...
\footnote{This work is supported by the ERC InvariantClass grant 320959.
The source code to reproduce figures and experiments is available at
...
\begin{table*}[t]
    ...
    \begin{tabular}{|c|cccccccc|c|}
        ...
        \hline
        bag-of-features
        & 49.9 & \textbf{92.7} & 81.6 & 22.5 & \textbf{99.7} & \hphantom{0}4.4 & 63.7 & \textbf{76.2} & 61.4 \\
        and random forest
