...
from keras.layers.advances_activations import LeakyReLU
...
def build_graph(
    ...
    graph.add_node(pool1, name="pool1", input="conv1")
    ...
    graph.add_node(flatten, name="drop1", input="flatten")
    ...
    graph.add_node(name="dense2", input="drop2")
